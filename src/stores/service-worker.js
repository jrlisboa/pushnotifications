...
importScripts('https://www.gstatic.com/firebasejs/4.1.0/firebase-app.js');
importScripts('https://www.gstatic.com/firebasejs/4.1.0/firebase-messaging.js');

// Initialize the Firebase app in the service worker by passing in the
// messagingSenderId.
firebase.initializeApp({
  'messagingSenderId': '744488072277'
});
...
function showNotification(message) {
  ...
  const notificationTitle = 'Vérios ';
